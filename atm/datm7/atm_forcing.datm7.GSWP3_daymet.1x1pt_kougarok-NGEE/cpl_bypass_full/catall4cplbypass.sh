...
y0=1980
y1=2010
fileheader=../Precip3Hrly/clmforc.GSWP3_daymet.1x1pt_kougarok-NGEE.Prec.
...
ncks -O --fix_rec_dmn DTIME all_hourly0.nc -o all_hourly0.nc
ncpdq -a lat,lon,DTIME all_hourly0.nc all_hourly1.nc
mv all_hourly1.nc all_hourly0.nc
...
#ncatted -O -a scale_factor,PRECTmms,a,d,"1.0e-7" all_hourly1.nc -o all_hourly1.nc
#ncatted -O -a scale_factor,PSRF,a,d,"1.0e2" all_hourly1.nc -o all_hourly1.nc

# adding 2 constants
#ncap2 -O -s "start_year=$y0" all_hourly1.nc -o all_hourly2.nc
#ncap2 -O -s "end_year=$y1" all_hourly2.nc -o all_hourly2.nc
